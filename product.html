    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="owl-carousel product-carousel">
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center align-items-center">
                        <img class="img-fluid mb-4" src="img/product-1.png" alt="">
                        <h6 class="text-uppercase">Quality Pet Foods</h6>
                        <h5 class="text-primary mb-0">$199.00</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href="https://api.whatsapp.com/send?phone=919900266213&text=I%20want%20to%20preebook%20this%20product"><i class="bi bi-whatsapp"></i></a>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center align-items-center">
                        <img class="img-fluid mb-4 img1" src="img/product-2.png" alt="">
                        <h6 class="text-uppercase">Quality Pet Foods</h6>
                        <h5 class="text-primary mb-0">$199.00</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href="https://api.whatsapp.com/send?phone=919900266213&text=I%20want%20to%20preebook%20this%20product"><i class="bi bi-whatsapp"></i></a>
        ...
        <div class="container py-5">
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-7">
                    ...
                    <p class="text-white mb-4">Buy the best quality products from our store. Now get 10% off on all the products upto ₹60 </p>
