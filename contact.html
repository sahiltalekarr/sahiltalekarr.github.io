    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="col-lg-5 d-flex">
                <div class="bg-light mb-5 ms-3"
                    style="background-color:#656565; padding-right:20rem ; padding-bottom: 2rem; padding-top: 2rem;">

                    <div class="d-flex align-items-center mb-2 mt-3 ms-5">
                        <i class="bi bi-geo-alt fs-1 text-primary me-6"></i>
                        <div class="text-start ms-3">
                            <h6 class="text-uppercase mb-1 ">Our Office</h6>
                            <span>Pikle Road, beside IDBI Bank, Karwar, Karnataka 581301</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 ms-5">
                        <i class="bi bi-phone-vibrate fs-1 text-primary me-3"></i>
                        <div class="text-start">
                            <h6 class="text-uppercase mb-1">Call Us</h6>
                            <span>+91 87626 70084</span>
                ...
                <div class="" style="margin-left: 3rem;">
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            <iframe
                                src="https://maps.google.com/maps?q=animall%20pet%20store%20karwar&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
                                id="gmap_canvas" frameborder="0" scrolling="no"
                                style="width: 400px; height: 300px;"></iframe>
                            <a href="https://technologg.com/apa-citation-generator/">APA Citation Generator</a>
                            <style>
                                .mapouter {
                                    position: relative;
                                    text-align: right;
